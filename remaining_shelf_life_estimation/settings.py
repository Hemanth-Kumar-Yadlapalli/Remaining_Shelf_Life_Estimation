...
ROOT_URLCONF = 'remaining_shelf_life_estimation.urls'
...
WSGI_APPLICATION = 'remaining_shelf_life_estimation.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'remaining_shelf_life_estimation',
        'USER':'root',
        'PASSWORD': 'root',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
